...
class VariationalELBOMF_LBFGS(VariationalELBO):
    ...
    def __init__(self, model, num_data, num_fidelities, num_fixed_mc_samples = 25):

        super().__init__(None, model, num_data)
        self.num_data = num_data
        self.num_fidelities = num_fidelities
        self.num_fixed_mc_samples = num_fixed_mc_samples
    ...
    def forward(self, l_approximate_dist_f, target, fidelities, include_kl_term = True):
        ...
        return data_term / self.num_fixed_mc_samples, kl_divergence
