...
class ThreeDGPLayer(DeepGP):
    def __init__(self, train_x_shape, lengthscale=None, covar_noise=None, fixed_noise=None, num_output_dims=1):
        ...
        if lengthscale is not None:
            ...
            hidden_layer_2.covar_module.base_kernel.raw_lengthscale = ini_lengthscale # DFS: The lengthscale of the second layer should be also initialiced with the heuristic DHL said?
            last_layer.covar_module.base_kernel.raw_lengthscale     = ini_lengthscale # DFS: The lengthscale of the last layer should be also initialiced with the heuristic DHL said?
